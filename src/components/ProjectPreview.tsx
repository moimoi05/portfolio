...
function WebsitePreview({ isVietnamese }: { isVietnamese: boolean }) {
  return (
    <figure className="nam-website-preview" aria-label={isVietnamese ? 'Ảnh chụp website GUU & T DESIGN' : 'Screenshots from the live GUU & T DESIGN website'}>
      <img className="nam-site-home" src="/images/guut/homepage.png" alt={isVietnamese ? 'Trang chủ website GUU & T DESIGN' : 'GUU & T DESIGN live website homepage'} loading="lazy" decoding="async" width="1440" height="1000" />
      <img className="nam-site-interiors" src="/images/guut/interiors.png" alt={isVietnamese ? 'Kiến trúc nội thất trên guut.com.vn' : 'Interior architecture showcased on guut.com.vn'} loading="lazy" decoding="async" width="1440" height="1000" />
      <img className="nam-site-detail" src="/images/guut/detail.png" alt={isVietnamese ? 'Chi tiết website GUU & T DESIGN' : 'Detail of the GUU & T DESIGN live website'} loading="lazy" decoding="async" width="1440" height="1000" />
